...
class BasicStaticXmlCompilerTest 
{
	...
	{
		var code = BasicStaticXmlCompiler.compile( this._applicationAssembler, "context/xml/static/multiMapTypeAttributes.xml", "BasicStaticXmlCompiler_testMultiMapTypeAttributes" );
		code.execute();
